...
import GelbudSlidingText from "./SlidingText";
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            <p className="text-gray-700 text-lg mb-6">
              Gelar Budaya adalah event seni tahunan yang diselenggarakan oleh
              BEM FIKTI UG sebagai wadah ekspresi mahasiswa dalam menampilkan
