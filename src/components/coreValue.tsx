...
const CoreValue: React.FC = () => {
  ...
  return (
    <motion.div
      className="flex flex-col w-full justify-center border-t-2 py-20 border-slate-700 rounded-md bg-[#060E23] 84%"
      initial="hidden"
      animate="visible"
      variants={{
        hidden: { opacity: 0 },
    ...
    >
      ...
      >
        <motion.div className="md:1/3 mx-auto p-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="36"
            width="40"
            viewBox="0 0 640 512"
            className="mx-auto md:w-40 md:h-32"
          >
            <path
              fill="#ff801f"
          ...
          <motion.h1 className="mt-10 mx-auto text-base md:text-3xl text-center font-medium">
            Dekat
          </motion.h1>
        </motion.div>
        <motion.div>
