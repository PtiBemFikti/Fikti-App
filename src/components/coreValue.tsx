...
const CoreValue: React.FC = () => {
  ...
  return (
    <motion.div className="flex flex-col w-full justify-center border-t-2 py-20 border-slate-700 rounded-md bg-[#060E23] 84%">
      <motion.h1
      ...
      >
        ...
        >
          <svg
            ...
            width="40"
            viewBox="0 0 640 512"
            className="mx-auto md:w-60 md:h-52"
          >
            <path
              fill="#ff801f"
          ...
          <motion.h1
            className="mt-10 mx-auto text-base md:text-3xl text-center font-medium"
            initial={{ opacity: 0, x: -100 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 0.2 }}
          >
