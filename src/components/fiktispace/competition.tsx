      ...
      <div className="flex flex-col px-4 md:px-10 lg:px-40 py-4">
        <div className="flex flex-wrap bg-[#0A2352] bg-opacity-50 p-6 gap-y-6 rounded-xl justify-between mb-5">
          <div className="flex flex-col bg-gradient-to-b from-[#FECB62] to-[#98783B] py-6 px-8 lg:px-14 rounded-2xl gap-4 w-full md:w-[48%] lg:w-[32%]">
            ...
            <div className={`${Lato.className} underline text-center mt-2`}>
              learn more
            </div>
          </div>
          ...
          <div className="flex flex-col bg-gradient-to-b from-[#FECB62] to-[#98783B] py-6 px-8 lg:px-14 rounded-2xl gap-4 w-full md:w-[48%] lg:w-[32%]">
            <div className={`${AkiraExpanded.className} text-[#0A2352] text-[1.975rem] text-center`}>
              Billiard
            </div>
            <div className={`${Lato.className}`}>
              <button className="bg-[#0A2353] text-center w-full rounded-lg p-1">Sport</button>
          ...
          <div className="flex flex-col bg-gradient-to-b from-[#FECB62] to-[#98783B] py-6 px-8 lg:px-14 rounded-2xl gap-4 w-full md:w-[48%] lg:w-[32%]">
            <div className={`${AkiraExpanded.className} text-[#0A2352] text-[1rem] leading-none text-center`}>
          ...
          <div className="flex flex-col bg-gradient-to-b from-[#FECB62] to-[#98783B] py-6 px-8 lg:px-14 rounded-2xl gap-4 w-full md:w-[48%] lg:w-[32%]">
            <div className={`${AkiraExpanded.className} text-[#0A2352] text-[0.975rem] leading-none text-center`}>
