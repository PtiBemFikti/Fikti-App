    ...
    SyllabusModule > = {
        "PERATURAN DAN KETENTUAN UMUM": {
            points: [
              ...
              "2. Peserta akan melakukan kegiatan fotografi secara on-site selama pelaksanaan FIKTI SPACE berlangsung..", 
              "3. Peserta harus terdaftar secara resmi sebelum batas waktu pendaftaran yang telah ditentukan.", 
              "4. Foto harus orisinal dan belum pernah dipublikasikan atau diikutsertakan dalam lomba lain.", 
              "5. Peserta wajib mengirimkan 3 foto yang mewakili masing-masing kategori: Seni, Sport, Esport.",
              "6. Setiap foto harus dikirim dalam dua versi: Before (mentah) dan After (final edit).",
              "7. Editing diperbolehkan dalam batas wajar (color grading, cropping, dll.), tetapi tidak boleh mengubah elemen utama foto.",
              "8. Format file: JPG atau PNG dengan resolusi minimal 1080p.",
              "9. Foto dikirim melalui email atau form yang telah disediakan sebelum deadline.",
              "10. Foto tidak mengandung unsur SARA, pornografi, kekerasan, sadisme, atau hal-hal yang tidak sesuai norma kesopanan.",
              "11. Peserta dilarang mengirim karya yang mengandung unsur plagiarisme (menjiplak/menggunakan karya orang lain, termasuk dari internet).",
              "12.Peserta dilarang mengirim karya yang mengandung unsur promosi merek/produk tanpa izin. ",
              "13. Keputusan juri bersifat mutlak dan tidak dapat diganggu gugat. ",
              "14. Karya akan didiskualifikasi jika melanggar larangan di atas, bukan hasil karya sendiri, atau dikirim melewati batas waktu tanpa pemberitahuan resmi.",
              "15. Hak cipta tetap milik peserta, tetapi panitia berhak menggunakan karya untuk keperluan publikasi lomba dengan tetap mencantumkan kredit nama fotografer. ",              
            ]
        },
