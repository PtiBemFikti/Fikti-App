  ...
  return (
    <div className="pt-28">
      ...
      <div className="px-6 md:px-10 lg:px-16 -mb-28">
        <Image
          src={"/fiktispace/Banner/Basket.webp"}
          alt="banner"
          width={1000}
          height={200}
          ...
          <div className="bg-[#FECB62] rounded-xl p-5 flex flex-col gap-y-3">
            ...
            <div className="bg-[#0A2352] px-6 lg:px-12 py-6 rounded-3xl">
              ...
              <div className={`${Lato.className} mt-4 text-sm md:text-xl`}>
                Nazua&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 0858-1919-1776 <br/>Nayla &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 0858-8332-1315
              </div>
            </div>
            {/* HTM */}
            <div className="bg-[#0A2352] px-6 lg:px-12 py-6 rounded-3xl">
        ...
        <div className="lg:w-1/2">
            ...
            <div className="relative mt-4">
              ...
              <div className="space-y-5 pl-[1.6rem]">
                {[
                  ...
                  { date: "18, 21 June", title: "Competition Day", location: "On-site" },
                    ].map((item, idx) => (
          ...
          <div className="bg-[#FECB62] text-center items-center w-full rounded-2xl mt-4 mb-5 p-4">
            <div>
              ...
              <Link className="" href="https://docs.google.com/forms/d/e/1FAIpQLSeDWpc86i2JvmipbyuAJzg5ITxt3KeFuajx0ytI8jDeCAS8nw/viewform?usp=preview" target="_blank" rel="noopener noreferrer">
