    ...
    SyllabusModule > = {
        "PERATURAN DAN KETENTUAN UMUM": {
            points: [
              ...
              "2. Pemain dapat memilih tim nasional atau klub sesuai keinginan sendiri.", 
              "3. Tim yang digunakan harus disetujui oleh lawan sebelum pertandingan dimulai.", 
              "4. Pengaturan pertandingan: Injuries: Off, Handball: Off, Offside: On, Weather: Clear, Stadium: Netral (sesuai kesepakatan).",
              "5. Level pertandingan: Super Star",
              "6. Substitusi: maksimal 3 kali",
              "7. Emotikon pemain: Off",
              "8. Kondisi Home & Away: Yellow (Normal)",
              "9. Cedera: Off",
              "10. Waktu pertandingan, Extra Time, dan Penalty Kick akan disesuaikan kemudian.",
              "11. Radar appearance: Bottom/Translucent ",
              "12. Time score: On ",
              "13. Stamina gauge: On",
              "14. Power gauge: On ",
              "15. Kamera: Dynamic Wide untuk semua pertandingan.",
              "16. Speed game: 0 (standar kecepatan normal)",
              "17. Kategori: Tim Klub ",
              "18. Stats tim diatur sama rata.",
              "19. ause hanya diperbolehkan untuk mengganti taktik atau pemain, dengan maksimal durasi pause 5 menit. ",             
            ]
        },
