    ...
    SyllabusModule > = {
        ...
        "SYARAT DAN KETENTUAN PESERTA": {
            points: [
              ...
              "5. Jersey harus memiliki nomor punggung dan nomor di dada, serta nomor pada celana di bagian paha kanan.",
              "6. Pemain wajib memakai kaos kaki dan sepatu karet selama bertanding.",
              "7. Libero harus memakai seragam dengan warna berbeda dari team utama.",
              "8. Team yang pertama mencapai 3 set kemenangan dinyatakan sebagai pemenang pertandingan.",
              "9. Menggunakan sistem rally point, setiap reli menghasilkan poin untuk salah satu tim.",
              "10. Pemain harus melakukan rotasi searah jarum jam setiap kali mendapatkan hak servis setelah memenangkan reli.",
              "11. Setiap team mendapatkan 2 kali timeout per set, masing-masing berdurasi 30 detik.",
              "12. Timeout hanya boleh diminta oleh pelatih atau kapten team saat bola mati.",
            ]
        }
    };
