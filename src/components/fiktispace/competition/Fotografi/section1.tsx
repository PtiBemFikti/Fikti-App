      ...
      <div className="md:flex md:gap-14">
        <div className="w-80 flex flex-col gap-5">
          <div className="bg-[#DDDCE8] rounded-2xl">
            <Image src="/fiktispace/competition/Fotografi.png" alt="" width={320} height={360} />
        ...
        <div className="md:w-[752px]">
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <ol className="text-black list-decimal pl-10 md:pl-14 font-Urbanist text-sm md:text-base">
              ...
              <li>Peserta hanya diperbolehkan untuk mengambil gambar di wilayah kampus Universitas Gunadarma di lokasi manapun.</li>
              <li>Peserta diperbolehkan menggunakan kamera digital SLR/Mirrorless dan bebas menggunakan segala macam merk kamera</li>
              <li>
                Peserta diperbolehkan menggunakan teknik olah digital, sebatas memperbaiki kualitas foto <i> (sharpening, cropping, color balance, level, dodge/burn, saturasi)</i> tanpa mengubah objek foto aslinya.
              </li>
              <li>
                Peserta wajib memberikan penjelasan singkat mengenai konsep. Penjelasan diketik dengan jenis huruf Times New Roman 12 pt maksimal 500 kata dalam format PDF dengan melampirkan Nama, Fakultas, Judul Karya, serta Tanda Tangan
                Digital di bagian pojok kiri atas.
              </li>
              <li>Karya tidak mengandung unsur SARA, provokatif, dan yang menyesatkan.</li>
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <Image src="/fiktispace/competition/kriteriaPenilaianFoto.png" alt="" width={752} height={288} className="pl-5 hidden md:block" />
            <Image src="/fiktispace/competition/kriteriaPenilaianFotoMobile.png" alt="" width={320} height={298} className="pl-1 md:hidden block" />
          </div>
        </div>
      </div>
    </div>
