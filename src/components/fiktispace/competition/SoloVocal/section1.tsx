      ...
      <div className="md:flex md:gap-14">
        <div className="w-80 flex flex-col gap-5">
          <div className="bg-[#DDDCE8] rounded-2xl">
            <Image
              src="/fiktispace/competition/SoloVocal.png"
              alt=""
              width={320}
              height={360}
            />
          ...
          <button className="bg-[#FFFEFD] border border-[#B9B6CF] w-full rounded-2xl h-16">
            <Link href={"https://forms.gle/mDyNEr6aa8UmoQZq9"}>
              <h1 className="text-[#16104B] font-Urbanist text-lg md:text-xl">
        ...
        <div className="md:w-[752px]">
          ...
          <div className="font-Urbanist text-[#000000] text-center border border-[#BFB8B0] px-6 py-3 rounded-xl mt-4 w-fit">
            <h1>
              Peserta di <b>wajibkan</b> menggunakan 2 Device (1 untuk mengikuti
              Zoom Cloud Meetings dan 1 untuk merekam penampilan saat itu juga)
            </h1>
          </div>
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <ol className="text-black list-decimal pl-10 md:pl-14 font-Urbanist text-sm md:text-base">
              <li>
                Peserta menyanyikan salah satu dari lima (5) judul lagu pilihan
                berikut: <br />
              ...
              <li>
                Peserta diperbolehkan menggunakan instrumen atau diiringi oleh
                alat musik.
              </li>
              <li>
                Peserta wajib{" "}
                <b>menggunakan setidaknya dua (2) perangkat yang memadai</b>{" "}
                dimana: <br />
                <ol className="list-lower-alpha pl-4">
                  <li>
                    Perangkat pertama bisa berupa handphone / laptop untuk
                    mengikuti Zoom Cloud Meetings dan menyanyikan lagu secara
                    langsung di hadapan juri;
                  </li>
                  <li>
                    Perangkat kedua bisa berupa handphone / laptop untuk merekam
                    penampilan saat itu juga. Nantinya hasil rekaman tersebut
                    akan dikirimkan ke panitia;
                  </li>
              ...
              <li>
                ...
                <ol className="list-lower-alpha pl-2  md:pl-4">
                  <li>
                    ...
                    dengan format “Pasfoto_NamaLengkap_NamaFakultas.jpg” untuk
                    mahasiswa/i aktif Universitas Gunadarma dan
                    “Pasfoto_NamaLengkap_AsalSekolah.jpg” untuk siswa/i SMA;
                  </li>
                  <li>
                    <b>KRS ATA 2023/2024</b> dengan format
                    “KRS_NamaLengkap_NamaFakultas.pdf” untuk mahasiswa/i aktif
                    Universitas Gunadarma dan scan kartu pelajar dengan format
                    “NISN_NamaLengkap_AsalSekolah.pdf” untuk siswa/i SMA;.
                  </li>
                  <li>
                    <b>Screenshot bukti follow Instagram @fiktispace.ug</b>{" "}
                    dengan format “FSPACE_NamaLengkap_NamaFakultas.jpg” untuk
                    mahasiswa/i aktif Universitas Gunadarma dan
                    “FSPACE_NamaLengkap_AsalSekolah.pdf” untuk siswa/i SMA;.
                  </li>
                  <li>
                    <b>
                      Bukti pembayaran pendaftaran sebesar Rp30.000,- ke
                      [rekening bendahara] a/n [nama bendahara]
                    </b>{" "}
                    dengan format BuktiPembayaran_NamaLengkap_Fakultas.jpg untuk
                    mahasiswa/i aktif Universitas Gunadarma dan
                    “BuktiPembayaran_NamaLengkap_Sekolah.jpg” untuk siswa/i
                    SMA;.
                  </li>
                </ol>
              </li>
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <Image
              src="/fiktispace/competition/kriteriaPenilaianSV.png"
              alt=""
              width={752}
              height={288}
            ...
            />
            <Image
              src="/fiktispace/competition/kriteriaPenilaianSVMobile.png"
              alt=""
              width={320}
              height={298}
