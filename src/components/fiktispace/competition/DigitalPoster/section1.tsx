      ...
      <div className="md:flex md:gap-14">
        <div className="w-80 flex flex-col gap-5">
          <div className="bg-[#DDDCE8] rounded-2xl">
            <Image
              src="/fiktispace/competition/DigitalPoster.png"
              alt=""
              width={320}
              height={360}
            />
        ...
        <div className="md:w-[752px]">
            ...
            <ol className="text-black list-decimal pl-10 md:pl-14 font-Urbanist text-sm md:text-base">
              ...
              <li>
                ...
                <ol className="list-lower-alpha pl-4">
                  <li>
                    Menciptakan kesetaraan dan toleransi terhadap semua
                    identitas seksual;
                  </li>
              ...
              <li>
                Objek dalam karya boleh menggabungkan foto, ilustrasi, dengan
                teks.
              </li>
              <li>
                Peserta lomba melampirkan Nama, Fakultas, Judul Karya, serta
                Tanda Tangan Digital di bagian pojok kanan bawah karya.
              </li>
              <li>
                Akan ada nilai tambahan untuk penjelasan singkat mengenai
                konsep. Penjelasan diketik dengan jenis huruf Times New Roman 12
                pt maksimal 500 kata dalam format PDF.
              </li>
              <li>
                Karya tidak boleh mengandung unsur SARA, provokatif, dan yang
                menyesatkan.
              </li>
              <li>
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <Image
              src="/fiktispace/competition/kriteriaPenilaian.png"
              alt=""
              width={752}
              height={288}
            ...
            />
            <Image
              src="/fiktispace/competition/kriteriaPenilaianMobile.png"
              alt=""
              width={320}
              height={298}
