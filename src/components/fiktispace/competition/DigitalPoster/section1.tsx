      ...
      <div className="md:flex md:gap-14">
        <div className="w-80 flex flex-col gap-5">
          <div className="bg-[#DDDCE8] rounded-2xl">
            <Image src="/fiktispace/competition/DigitalPoster.png" alt="" width={320} height={360} />
            <div className="flex font-Urbanist px-3 py-4 justify-center gap-2 items-center">
              <h1 className="text-[#301443] font-bold text-3xl">Digital Poster</h1>
          ...
          <div className="font-Urbanist px-4 py-3 flex flex-col gap-3 bg-[#E8E8F0] rounded-2xl">
            ...
            <div className="font-Urbanist text-[#050A10] text-sm tracking-tighter">
              ...
              <p>
                <b>Penunjukan Hasil Karya:</b> 24 Juni 2024
              </p>
            </div>
        ...
        <div className="md:w-[752px]">
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <ol className="text-black list-decimal pl-10 md:pl-14 font-Urbanist text-sm md:text-base">
              <li>Tema: “Stop Pelecehan Seksual”</li>
              <li>
                Karya didedikasikan untuk mempengaruhi masyarakat agar: <br />
                <ol className="list-lower-alpha pl-4">
                  <li>Menciptakan kesetaraan dan toleransi terhadap semua identitas seksual;</li>
                  <li>Membangun lingkungan yang lebih aman;</li>
                  <li>Meningkatkan kesadaran bersama;</li>
                  <li>Teredukasi pentingnya pendidikan seksual; dan/atau</li>
                  <li>Mendorong perubahan positif.</li>
                </ol>
              </li>
              <li>Objek dalam karya boleh menggabungkan foto, ilustrasi, dengan teks.</li>
              <li>Peserta lomba melampirkan Nama, Fakultas, Judul Karya, serta Tanda Tangan Digital di bagian pojok kanan bawah karya.</li>
              <li>Akan ada nilai tambahan untuk penjelasan singkat mengenai konsep. Penjelasan diketik dengan jenis huruf Times New Roman 12 pt maksimal 500 kata dalam format PDF.</li>
              <li>Karya tidak boleh mengandung unsur SARA, provokatif, dan yang menyesatkan.</li>
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <ol className="text-black list-decimal pl-10 md:pl-14 font-Urbanist text-sm md:text-sm">
              ...
              <li>
                ...
                <ol className="list-lower-alpha md:pl-4">
                  <li>Pas foto berwarna ukuran 3 x 4 (background biru/merah) dengan format “Pasfoto_NamaLengkap_NamaFakultas.jpg”.</li>
                  <li>KRS ATA 2023/2024 dengan format “KRS_NamaLengkap_NamaFakultas.pdf”.</li>
                  <li>Screenshot bukti follow Instagram @fiktispace.ug dengan format “FSPACE_NamaLengkap_NamaFakultas.jpg”.</li>
                  <li>Bukti pembayaran pendaftaran sebesar Rp30.000,- ke [rekening bendahara] a/n [nama bendahara] dengan format BuktiPembayaran_NamaLengkap_Fakultas.jpg.</li>
                </ol>
              </li>
            </ol>
          </div>
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <Image src="/fiktispace/competition/kriteriaPenilaian.png" alt="" width={752} height={288} className="pl-5 hidden md:block" />
            <Image src="/fiktispace/competition/kriteriaPenilaianMobile.png" alt="" width={320} height={298} className="pl-1 md:hidden block" />
          </div>
        </div>
      </div>
    </div>
