  ...
  return (
    <div className="pt-28">
      ...
      <div className="px-6 md:px-10 lg:px-16 -mb-28">
        <Image
          src={"/fiktispace/Banner/Mobile Legend.webp"}
          alt="banner"
          width={1000}
          height={200}
        ...
        <div className="lg:w-1/2">
            ...
            <div className="relative mt-4">
              ...
              <div className="space-y-5 pl-[1.6rem]">
                {[
                  ...
                  { date: "15, 17, 18 June", title: "Competition Day", location: "On-site" },
                    ].map((item, idx) => (
          ...
          <div className="bg-[#FECB62] text-center items-center w-full rounded-2xl mt-4 mb-5 p-4">
            <div>
              ...
              <Link className="" href="https://docs.google.com/forms/d/e/1FAIpQLSdoIa6UBKKkd7UxAyC3bCIAsclj5D278jzEe_GpMVjSKcBBiw/viewform" target="_blank" rel="noopener noreferrer">
