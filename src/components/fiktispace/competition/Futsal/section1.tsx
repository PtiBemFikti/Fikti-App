      ...
      <div className="md:flex md:gap-14">
        <div className="w-80 flex flex-col gap-5">
          <div className="bg-[#DDDCE8] rounded-2xl">
            <Image
              src="/fiktispace/competition/Futsal.png"
              alt=""
              width={320}
              height={360}
            />
            <div className="flex font-Urbanist px-3 py-4 justify-center gap-2 items-center">
              <h1 className="text-[#301443] font-bold text-6xl">Futsal</h1>
          ...
          <div className="font-Urbanist px-4 py-3 flex flex-col gap-3 bg-[#E8E8F0] rounded-2xl">
            ...
            <div className="font-Urbanist text-[#050A10] text-sm tracking-tighter">
              ...
              <p>
                <b>Periode Kompetisi:</b> 22 Juni - 29 Juni 2024
              </p>
            </div>
        ...
        <div className="md:w-[752px]">
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <h1 className="text-black pl-8 font-Urbanist text-base md:text-lg font-bold">
              Peserta:
            </h1>
            <ol className="text-black list-decimal pl-10 font-Urbanist text-sm md:text-base">
              <li>
