      ...
      <div className="md:flex md:gap-14">
        <div className="w-80 flex flex-col gap-5">
          <div className="bg-[#DDDCE8] rounded-2xl">
            <Image src="/fiktispace/competition/Futsal.png" alt="" width={320} height={360} />
        ...
        <div className="md:w-[752px]">
          ...
          <div className="flex p-3 flex-col gap-3">
            ...
            <h1 className="text-black pl-8 font-Urbanist text-base md:text-lg font-bold">Peserta:</h1>
            <ol className="text-black list-decimal pl-10 font-Urbanist text-sm md:text-base">
