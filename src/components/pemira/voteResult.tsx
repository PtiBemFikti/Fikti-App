        ...
        <div className="md:w-1/2">
          ...
          <div className="px-4 md:px-0">
            <div className="w-full bg-[#EAECF0] rounded-3xl p-6 flex justify-between gap-2 md:py-9">
              <div className="">
                <p className="font-bold text-[#101415] md:text-2xl">Time Remaining</p>
              ...
              <div className="flex justify-between items-center gap-3 md:gap-8">
                <div className="flex flex-col items-center">
                  <p className={`${Urbanist.className} text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-l from-[#669BBC] to-[#003049]`}>02</p>
                  <p className="text-[#98A2B3]">Hours</p>
                </div>
                <div className="flex flex-col items-center">
                  <p className={`${Urbanist.className} text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-l from-[#669BBC] to-[#003049]`}>25</p>
                  <p className="text-[#98A2B3]">Minutes</p>
                </div>
                <div className="flex flex-col items-center">
                  <p className={`${Urbanist.className} text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-l from-[#669BBC] to-[#003049]`}>45</p>
                ...
                <div className="w-full bg-[#F0F2F4] rounded-xl flex justify-between items-center">
                  ...
                  <div className="text-[#101415] text-2xl px-6">
                    <div className={` ${Urbanist.className} flex md:gap-2 gap-1`}>
                      <p className="md:text-4xl bg-clip-text text-transparent bg-gradient-to-l from-[#669BBC] to-[#003049] font-bold">350</p> <p className="md:text-base text-[#98A2B3] md:mt-3 text-sm mt-2">Votes</p>
                    </div>
                  </div>
                </div>
              </div>
