          ...
          <div className="p-5 md:px-0 md:py-3 flex gap-2 md:gap-5">
            <div className="w-1/2 bg-[#EAECF0] rounded-3xl p-4 flex flex-col justify-center items-center md:justify-start md:items-start md:p-6">
              <div className="flex gap-2 items-center">
                <Image src={'/pemira/ceklis.png'} alt="ceklis" width={16} height={16} className="w-5 md:w-6" />
                <p className="text-[#101415] font-bold mt-1 md:text-2xl">Total Votes</p>
              </div>
              <div className="text-sm text-[#98A2B3] py-5 md:py-3 md:text-xl">
                <p>Jumlah suara yang sudah terkonfirmasi</p>
              </div>
              <div className="flex justify-center items-center">
                <p className="font-bold text-3xl md:text-6xl text-[#101415]">1.200</p>
                <p className="text-[#98A2B3] text-sm md:text-3xl font-bold pt-3">/2.400</p>
              </div>
            </div>
            <div className="w-1/2 bg-[#EAECF0] rounded-3xl p-4 flex flex-col justify-center items-center md:justify-start md:items-start md:p-6">
              <div className="flex gap-2 items-center">
              ...
              <div className="flex justify-center items-center mx-auto">
                <p className="font-bold text-3xl text-[#101415] md:text-6xl">50%</p>
              </div>
            </div>
          </div>
            ...
            <div className="w-full bg-[#EAECF0] rounded-3xl p-6 flex justify-between gap-2 md:py-9">
              ...
              <div className="flex justify-between items-center gap-3 md:gap-8">
                <div className="flex flex-col items-center">
                  <p className="text-4xl md:text-6xl font-bold text-[#101415]">02</p>
                  <p className="text-[#98A2B3]">Hours</p>
                </div>
                <div className="flex flex-col items-center">
                  <p className="text-4xl md:text-6xl font-bold text-[#101415]">25</p>
                  <p className="text-[#98A2B3]">Minutes</p>
                </div>
                <div className="flex flex-col items-center">
                  <p className="text-4xl md:text-6xl font-bold text-[#101415]">45</p>
