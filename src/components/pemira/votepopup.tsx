...
const handleConfirmed: any = () => {
  const modalConfirmed = document.getElementById('vote-confirmed') as HTMLDialogElement;
    ...
    <div className={`modal-box bg-white ${epilogue.className}`}>
      <form method="dialog">
        <div className="flex gap-2 md:gap-5 items-center p-6 md:p-12">
          ...
          <p className={`text-black ${epilogue.className} font-bold md:text-3xl mt-1`}>Confirm Your Vote</p>
        </div>
        ...
        <div className="px-6 py-5 flex gap-3 md:px-12 md:py-10">
          ...
          <button onClick={handleConfirmed} className="bg-gradient-to-l from-[#669BBC] to-[#003049] w-32 md:w-1/2 md:text-xl text-[#F0F2F4] py-3 text-center rounded-lg text-sm font-bold">
            Confirm
          </button>
        </div>
      </form>
