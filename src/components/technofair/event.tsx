              ...
              <div className="w-72 h-96 bg-black rounded-[39px] border-[2px] flex justify-center items-center">
                <div className="w-64 h-72 m-8">
                  ...
                  <div className=' w-60 h-72'>
                    <p className=' w-64 h-9 mt-5 font-bold text-xl'>Big Data</p>
                    ...
                    <p className=' w-60 h-5 text-sm mt-5'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Learn more</p>
                  </div>
                </div>
              </div>
              <div className="h-96 bg-black rounded-[39px] border-[2px] w-72"></div>
              <div className="w-72 h-96 bg-black rounded-[39px] border-[2px]"></div>
              <div className="h-96 bg-black rounded-[39px] border-[2px] w-72"></div>
            </div>
          </div>
