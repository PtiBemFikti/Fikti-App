        ...
        <div className="flex-col">
          <div className="flex justify-center-items-center p-4 my-7">
            <div className="w-96 h-40 bg-gradient-to-t from-[#241525] to-[#833F57] text-center py-6 rounded-3xl">
              <h3 className={`font-bold text-3xl ${bricolageGrotesque.className}`}>
                <RotatingWords />
              </h3>
              <h2 className={`font-bold text-5xl mt-5 ${bricolageGrotesque.className}`}>In FutureTech</h2>
            </div>
          </div>
          ...
          <div className="mx-3 p-3">
            ...
            <p className={`text-[#241525] italic text-xl ${poppins.className}`}>Realizing the dynamic technological transformation through collaborative innovation in FutureTech.</p>
            <div className="flex justify-center items-center my-7">
              <div className="w-96 h-10 text-center bg-[#241525] rounded-[14px] hover:bg-[#262626] transition duration-100 ease-in-out">
                <Link href={'#event'} className="hover:bg-[#262626]">
                  <p className={`my-2 font-bold ${poppins.className}`}>What event do we do?</p>
                </Link>
              </div>
            </div>
          </div>
          <div className="">
            <div className="flex justify-center items-center gap-7">
              ...
              <h3 className={`font-bold text-black text-xl opacity-20 mt-5 ${poppins.className}`}>Click here to Sign Up</h3>
            </div>
            ...
            <div className="flex justify-center items-center gap-5 pb-10">
              ...
              <RotatingImage />
              <h3 className={`font-bold text-xl text-black opacity-20 ${poppins.className}`}>Scroll Down to Learn More</h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="md:block hidden">
        ...
        <div className="flex justify-center items-center gap-24 p-7">
          <div className=" w-[426px] h-[632px] border bg-gradient-to-t from-[#241525] to-[#833f57] rounded-3xl">
            <div className={`p-6 ${bricolageGrotesque.className}`}>
              <h1 className="font-bold text-4xl">
                Transformation, <br />
                Collaborative <br />
                Innovation
              </h1>
              <h1 className={`font-bold text-5xl ${poppins.className}`}>In FutureTech.</h1>
            </div>
            <div className="px-5">
          ...
          <div className="w-[635px] h-[632px] border bg-[#e9e9ed] rounded-3xl border-gray-100">
            ...
            <div className="px-7 my-6">
              ...
              <p className={`text-[#241525] italic text-xl my-3 ${poppins.className}`}>
            ...
            <div className="flex gap-3">
              <button>
                <Link href={'#event'} className="ml-7 flex gap-1">
                  <div className="flex justify-center items-center w-72 h-16 bg-[#241525] text-center rounded-l-3xl">
                    <p className={`text-lg ${poppins.className} font-semibold`}>What event do we do?</p>
                  </div>
              ...
              <button>
                <Link href={'#about'} className="flex bg-[#dddfe4] w-52 h-16 justify-center items-center gap-5 rounded-3xl shadow-md">
                  <p className={`text-[#241525] font-semibold text-lg ${poppins.className}`}>Learn More</p>
                  <div className="">
