    ...
    <div className="">
      ...
      <div className="mt-2 md:hidden">
        ...
        <div className="flex flex-col justify-center items-center py-6 gap-4">
          ...
          <div className="bg-[#e9e9edcc] w-80 h-40 rounded-[28px] border-[2px] border-[#dcdcdf80]">
            <div className="p-5">
          ...
          <div className="bg-[#e9e9edcc] w-80 h-48 rounded-[28px] border-[2px] border-[#dcdcdf80]">
          ...
          <div className="bg-[#e9e9edcc] w-80 h-64 rounded-[28px] border-[2px] border-[#dcdcdf80]">
            <div className="p-3">
              <p className="text-[#241525] text-center text-sm">
