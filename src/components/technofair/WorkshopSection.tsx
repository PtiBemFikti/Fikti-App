...
export default function WorkshopSection() {
    return(
        <div className="relative">
            ...
            <div className="absolute right-0 top-0 bg-[#FE8A16]  rounded-l-[50px] w-[80%] lg:w-[70%] h-full lg:h-[600px]"></div>

            <div className="lg:grid lg:grid-cols-[60%_40%] pb-10 lg:pb-0 lg:h-[550px]">
