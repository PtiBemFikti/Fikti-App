...
const AccordionCard: React.FC<AccordionCardProps> = ({ title, content }) => {
  ...
  return (
    <div className="bg-[#1E2749] rounded-3xl mb-4 text-[#b9bcc7] font-[Poppins] text-sm font-light">
      <button
        className="bg-[#1E2749] w-full px-4 py-2 text-left text-sm font-[Poppins] text-[#fff4e7] rounded-lg hover:bg-[#1E2749] focus:outline-none focus:ring-2 focus:ring-[#1E2749] focus:ring-offset-2 focus:ring-offset-gray-100 dark:text-gray-300 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-[#1E27490]"
