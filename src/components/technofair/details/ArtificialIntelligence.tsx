    ...
    <div className="bg-[#FFE9CF]">
      ...
      <div className="mt-10 pb-5">
        ...
        <div className="pt-6 text-center justify-center flex gap-6">
          <Link href="https://forms.gle/nz3W8yDUh9vzuQMJ7" className="text-sm md:text-xl text-black font-medium bg-[#FE8A16] py-2 w-32 md:w-44 rounded-full hover:bg-[#100F21] hover:text-white transition-colors duration-300">
          Registration
          </Link>
        </div>
      </div>
