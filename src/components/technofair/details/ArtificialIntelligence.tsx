    ...
    <div className="bg-gradient-to-t from-[#F7F9FA] to-[#F3E5EA]">
        ...
        <div className={`px-40 py-16 ${poppins.className}`}>
          <div className={`py-3 flex gap-16 ${bricolageGrotesque.className}`}>
            <div className="w-1/2 py-4">
              <Image src={'/technofair/AI.png'} alt="AI" width={461} height={346}  className='rounded-2xl'/>
            </div>
      ...
      <div className="md:hidden">
        <div className="py-4">
          <div className="px-5">
            <div className="py-3">
              <Image src={'/technofair/AI.png'} alt='AI' width={461} height={346} className='rounded-xl'/>
            </div>
          </div>
          <div className="px-5">
