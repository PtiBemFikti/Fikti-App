                ...
                <div className="py-2">
                  ...
                  <div className="py-5 flex gap-10">
                    ...
                    <div className="w-2/4 pt-14">
                      <Link href={'https://calendar.app.google/j4ph9hbL8ddvcbgr7'} className="w-80 h-20 bg-[#11111B] rounded-[8px] text-center flex flex-col justify-center items-center">
      ...
      <div className="md:hidden">
        <div className="py-4">
          ...
          <div className="">
            ...
            <div className="py-3">
              <Link href={'https://calendar.app.google/j4ph9hbL8ddvcbgr7'} className="flex flex-col justify-center items-center text-center w-screen h-20 bg-[#11111b]">
