              ...
              <div className="hidden md:block">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="rounded-lg bg-[#11111B] text-center text-[#FEFDFC] p-3">
                    ...
                    <h1 className="font-Poppins text-[14px] opacity-50"><a href="https://www.evernote.com/shard/s684/sh/ec3d6f5e-04b5-44e0-1e0d-a74efe767e81/vcXIHk3gIsWUOEUWylOs8SaTJ56qS5dzXSODneIy2DY0-UEduyvIOERsNA" target="_blank">Click here to save the date</a></h1>
                  </div>
                </div>
              </div>
            </div>
