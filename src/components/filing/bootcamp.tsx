                ...
                <div className="flex mx-8 justify-center items-center">
                  <div className="w-1/2 mt-2 rounded-3xl border-2 border-stone-400 justify-center items-start">
                    <div className="p-2">
                      ...
                      <div className="w-full ml-1 mt-8 text-neutral-600 text-base font-normal font-['Poppins']">
                  ...
                  <div className="w-1/2 mt-2 ml-4 rounded-3xl border-2 border-stone-400 justify-center items-start">
                    <div className="p-2">
                      ...
                      <div className="mx-1 tracking-tight text-start text-gray-800 text-2xl font-bold font-[arial]">
                        WEB DEVELOPMENT
                      </div>
                      <div className="mx-1 text-stone-500 text-sm font-light font-['Poppins']">
                      ...
                      <div className="w-full ml-1 mt-2 text-neutral-600 text-base font-normal font-['Poppins']">
