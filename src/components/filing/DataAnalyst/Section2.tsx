          ...
          <div className="font-Poppins text-[#545350] space-y-3">
            ...
            <div className="pl-7 text-[14px] md:text-[16px] space-y-3">
              <h1 className="font-semibold">
                Kuasai Data dan Jadilah Data Analyst dengan Bootcamp FILING!
              </h1>
              <h1 className="font-light md:font-normal">
                FILING hadir dengan bootcamp untuk membekali kamu dengan
                keterampilan dan pengetahuan yang dibutuhkan untuk menjadi Data
                Analyst yang handal.
              </h1>
              <h1 className="font-light md:font-normal">
                ...
                depan dengan mengolah data dan mencari solusi dari berbagai
                permasalahan.
              </h1>
              <div>
                <h1 className="font-light md:font-normal">
          ...
          <div className="font-Poppins text-[#545350] space-y-3">
            ...
            <div className="pl-7 text-[14px] md:text-[16px] space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <h1>
                  Memahami intro Data Analyst dan tools yang akan digunakan.
                </h1>
              </div>
              <div className="flex items-center gap-2">
                <Image src={check} alt="" className="w-8 h-8" />
                <h1>
                  Mengetahui dasar - dasar cara menggunakan Python dan Tableau.
                </h1>
              </div>
              <div className="flex items-center gap-2">
                <Image src={check} alt="" className="w-8 h-8" />
                <h1>
                  Dapat mengoperasikan tools yang berhubungan dengan Data
                  Analyst.
                </h1>
              </div>
              <div className="flex items-center gap-2">
                ...
                <h1>
                  ...
                  pengerjaan project Data Analyst.
                </h1>
              </div>
            </div>
          </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="rounded-lg bg-[#11111B] text-center text-[#FEFDFC] p-3">
                    ...
                    <h1 className="font-Poppins text-[14px] opacity-50">
                      <a
                        href="https://www.evernote.com/shard/s684/sh/703f1447-958f-2806-0be0-c2b1e0b47394/xhn5FAql2Cs2NXtJCQUiMvo4yQcpoD7sMaarBRPDow8RZbsHL0XU8mxo1w"
                        target="_blank"
                      >
