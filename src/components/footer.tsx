  ...
  return (
    <footer className="border-t-2 border-slate-700 rounded-md bg-gradient-to-b from-[#091534] to-[#060E23] to-[84%] p-4 bottom-0">
      <div className="flex flex-col md:flex-row justify-between gap-7">
        ...
        <div className="flex-initial md:w-96">
          ...
          <div className="flex flex-row gap-5 items-center mb-5">
            ...
            <Link
              href="/"
              className="text-gray-400 hover:text-purpleText flex gap-4 items-center"
            >
          ...
          <div className="flex flex-row gap-5 items-center mb-5">
            ...
            <Link
              href="/"
              className="text-gray-400 hover:text-purpleText flex gap-4 align-top"
            >
        ...
        <div className="flex-initial md:w-96">
          <iframe
            ...
            src="https://open.spotify.com/embed/artist/2iDVt6mFbtbDEZG5ax0dTi?utm_source=generator"
            width="100%"
            height="352"
            frameBorder="0"
      ...
      <div className="container mt-10">
        <p className="text-center border-t-2 mx-1 md:mx-20 border-gray-500 text-gray-400 text-xs md:text-base font-normal">
