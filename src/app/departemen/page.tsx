...
const About: React.FC = () => {
  ...
  return (
    <div className="">
      {/* section1 */}
      <motion.div className="mx-4 h-[80vh] md:h-[140vh] p-4 my-5 bg-[#f3f3f3] flex flex-col justify-center items-center rounded-2xl shadow-2xl">
        <motion.div
          className=""
        ...
        <motion.h1
          className="text-[#060e23] text-center font-semibold text-6xl md:text-9xl"
          initial="hidden"
          animate="visible"
          ref={kabinetTextRef}
        ...
        >
          PIMPINAN <br />
          <span className="text-orange-500">KABINET</span>
        </motion.h1>
        <motion.div
          className=""
          initial="hidden"
      ...
      {/* section3 */}
      <motion.div className="w-full h-[80vh] md:h-[200vh] p-4 py-2 bg-[#f3f3f3] flex flex-col justify-center items-center border-b-2 border-gray-500">
        <motion.h1
          className="text-[#060e23] text-center font-semibold text-4xl md:text-6xl mt-10"
          initial="hidden"
          animate="visible"
          ref={kabinetTextRef}
          variants={kabinetTextVariants}
      ...
      <motion.div className="w-full h-[150vh] md:h-[350vh] p-4 bg-[#060e23] flex flex-col justify-center items-center border-b-2 border-gray-500">
        ...
        >
          <Image
            ...
            alt=""
          />
          <motion.div className="flex flex-col bg-[#f3f3f3] rounded-xl w-[98vw] px-2 border-double border-4 border-[#060e23] justify-center items-center">
            <motion.div>
              <motion.h1
                className="text-[#060e23] text-center font-semibold text-3xl md:text-4xl mt-10"
                initial="hidden"
                animate="visible"
                ref={kabinetTextRef}
                variants={kabinetTextVariants}
          ...
          <motion.div className="flex flex-col bg-[#f3f3f3] rounded-xl w-[98vw] px-2 border-double border-4 border-[#060e23] justify-center items-center">
            ...
            <motion.div>
              <motion.h1
                ...
                transition={{ duration: 0.5, delay: 1 }}
              >
                DEPARTEMEN <br /> POLITIK & KESEJAHTERAAN MASYARAKAT
              </motion.h1>
