...
export const metadata: Metadata = {
  title: "Badminton Mens Double | FIKTI SPACE 4.0",
  description: "Cabang Olahraga Badminton Mens Double FIKTI SPACE 4.0 by Departemen ORSB BEM FIKTI Universitas Gunadarma",
  icons: {
