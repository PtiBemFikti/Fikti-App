  ...
  const descriptions = [
    {
      title: "Divisi Acara",
      deksripsi:
        "Mengatur seluruh rangkaian acara. Seperti membuat rundown acara beserta kebutuhannya, mencari pemateri, dll",
    },
    {
      title: "Divisi Humas",
      deksripsi:
  ...
  return (
    <div className="main w-full font-Lato text-[#FFF6E0]">
      ...
      <div className="flex relative">
        <Image
          src={"/oprec-volunteer/line-9.png"}
          alt="line-bg"
          width={1029}
          height={975}
          className="object-cover absolute mx-auto w-full -top-7 hidden md:block"
        />

        {/* gambar mobile */}
        <Image
          src={"/oprec-mobile/line-1-mobile.png"}
          alt="line-1"
          width={417}
          height={319}
          className="object-cover absolute mx-auto w-full -top-8 md:hidden block"
        />
        <div className="">
          <Image
            src={"/oprec-mobile/lingkaran-1-mobile.png"}
            alt="lingkaran"
            width={100}
            height={100}
            className="object-cover absolute ml-[246px] w-36 h-36 -top-2 md:hidden block"
          />
          <Image
            src={"/oprec-mobile/dots-2-mobile.png"}
            alt="dots 2"
            width={85}
            height={35}
            className="object-cover absolute right-1 w-10 top-36 md:hidden block"
          />
        </div>
        <Image
          src={"/oprec-mobile/dots-mobile.png"}
          alt="dots 1"
          width={85}
          height={35}
          className="object-cover absolute -ml-1 w-12 h-12 top-14 md:hidden block"
        />
        ...
        <div className="bg-[#662549] w-3/4 h-44 rounded-e-[40px] md:w-2/3 md:h-5/6 md:rounded-e-[200px] mt-28 md:mt-36 z-10">
          <div className="md:ml-20 md:my-12 md:py-12">
            ...
            <div className="md:ml-0">
              <div className="ml-3 my-4">
                <p className="text-xs md:text-lg">
                  Program kerja yang mewadahi mahasiswa aktif FIKTI UG untuk
                  berkontribusi dalam kepanitiaan acara dan kegiatan yang
                  diselenggarakan oleh <br /> BEM FIKTI UG.
                </p>
              </div>
            </div>
            <br />
            <div className="hidden md:block ml-3">
              ...
              <h4 className="text-2xl font-bold md:mb-2">
                15 Januari 2024 - 20 Januari 2024
              </h4>
              <br />
                ...
                <Link href={"#timeline"}>
                  <div className="px-3 py-1 bg-transparent rounded-full border border-brown-1 flex gap-1">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M15.4167 6.25L17.5001 4.16667L15.4167 2.08333"
                        stroke="#FFF6E0"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      />
          ...
          <div className="hidden md:block">
            <Image
              src={"/oprec-volunteer/dots-5.png"}
              alt="dots"
              width={100}
              height={100}
              className="absolute w-12 left-0 -bottom-9"
            />
          </div>
        </div>
        <div className="hidden md:w-1/2 md:block relative">
          <div className="flex relative">
            <div className="hidden md:block">
              <Image
                src={"/oprec-volunteer/bejo-1.png"}
                alt="people"
                width={461}
                height={431}
              ...
              >
                <div className="relative w-full h-full">
                  <Image
                    src={"/oprec-volunteer/lingkaran-2.png"}
                    alt="lingkaran"
                    width={400}
                    height={400}
                    className="absolute -top-40 -right-36 object-cover"
                  />
                </div>
              </div>
            </div>
          ...
          >
            <div className="relative w-full h-full">
              <Image
                ...
                width={150}
                height={150}
                className="absolute bottom-40 -right-10 object-cover"
              />
            </div>
          </div>
        </div>
      ...
      <div className="md:hidden block my-12 pb-32">
        <Image
          src={"/oprec-mobile/line-2-mobile.png"}
          alt="line 2"
          width={548}
          height={344}
          className="object-cover absolute w-full md:hidden block"
        />
        <div className="flex relative">
          <div className="w-1/2 ml-2 mt-6">
            <Image
              src={"/oprec-mobile/bejo-2.png"}
              alt="bejo"
              width={2000}
              height={2000}
              className="mx-auto"
          ...
          <div className="relative text-sm">
            <Image
              ...
              width={300}
              height={300}
              className="object-cover absolute w-10 top-64 ml-36"
            />
            <p className="text-sm ml-2 mt-5 mb-3 text-end">
              Skip ahead & choose!
            </p>
            <div className="flex flex-col gap-2">
              <Link href={"#timeline"}>
                <div className="mx-auto px-3 py-1 bg-transparent rounded-l-full border border-brown-1 flex gap-1 justify-end items-end ml-9">
                  <svg
                    className="my-auto w-6 h-6 pt-1"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
      ...
      <div id="timeline" className="flex justify-center items-center md:mt-60">
        <div className="hidden md:block">
          ...
          >
            <h1 className="md:text-6xl font-bold whitespace-nowrap">
              Project Timeline
            </h1>
            <p className="whitespace-nowrap overflow-hidden pt-2 md:text-sm">
              Agar tidak ketinggalan informasi terbaru, yuk, simpan <br />{" "}
              tanggal-tanggal penting di timeline ini!
            </p>
          </div>
        </div>
        <div className="md:hidden block">
          <div className="text-center items-center justify-center flex flex-col pb-4">
            <h1 className="text-3xl font-bold whitespace-nowrap z-10 mt-20">
              Project Timeline
            </h1>
            <p className="whitespace-nowrap overflow-hidden pt-2 text-xs z-10">
              Simpan tanggal-tanggal penting dibawah ini!
            </p>
          </div>
          <div className="relative">
            <Image
              src={"/oprec-mobile/lingkaran-mobile.png"}
              alt="lingkaran mobile"
              width={1500}
              height={1500}
              className="object-cover w-40 absolute -left-20 -top-56"
            />
          </div>
        </div>
      </div>
      ...
      <div className="md:w-full md:mt-5 hidden md:block">
        <Image
          src={"/oprec-volunteer/project-frame.png"}
          alt="dots group"
          width={1439}
          height={150}
      ...
      <div className="relative md:hidden block w-full mt-5">
        <Image
          src={"/oprec-mobile/timeline-mobile-2.png"}
          alt="timeline mobile"
          width={422}
          height={650}
          className="mx-auto w-full"
            ...
            <div className="flex gap-3 mt-2">
              ...
              >
                <g clip-path="url(#clip0_49_343)">
                  <path
                    d="M20.4 0.72168H3.6C1.61177 0.72168 0 2.33345 0 4.32168V21.1217C0 23.1099 1.61177 24.7217 3.6 24.7217H20.4C22.3882 24.7217 24 23.1099 24 21.1217V4.32168C24 2.33345 22.3882 0.72168 20.4 0.72168Z"
                    fill="#00B900"
                  />
                  <path
      ...
      <div
        id="project-list"
        className="md:w-full flex flex-col justify-center items-center mt-12 md:mt-36"
      >
        <div className="mb-7 md:mb-20 z-10">
          <h1 className="text-center text-3xl md:text-6xl font-bold whitespace-nowrap mt-20">
            Project List
          </h1>
        ...
        <div className="">
          <Image
            src={"/oprec-mobile/lingkaran-2.png"}
            alt="set-lingkaran"
            width={500}
            height={500}
            className="w-64 md:w-96 -mt-52 md:ml-[325px] md:-mt-96 -ml-16 absolute"
          />
          <Image
            src={"/oprec-mobile/lingkaran-3.png"}
            alt="set-lingkaran"
            width={500}
            height={500}
            className="w-64 md:w-96 mt-96 -ml-48 md:-ml-[710px] md:-mt-7 absolute"
          />
        </div>
        <div className="grid grid-rows-1 gap-7 z-10">
          <div className="w-5/6 md:w-2/3 mx-auto flex flex-col">
            <div className="bg-[#270548] w-full h-26 px-8 py-7 rounded-t-[48px]">
              ...
              <p className="text-xs md:text-sm pt-1">
                Hero of Educational and Social X
              </p>
            </div>
            <div
              className="px-7 md:px-auto py-7 backdrop-blur-[6.300000190734863px] bg-[#FFFFFF1A] rounded-b-[48px] bg-cover bg-no-repeat"
              style={{ backgroundImage: "url(/oprec-volunteer/list-bg-1.png)" }}
            >
              <p className="text-sm md:text-lg text-justify">
                HEROES X (Hero of Education and Social X) adalah kegiatan bakti
                sosial yang dilaksanakan oleh Mahasiswa/i FIKTI UG di wilayah
                yang memiliki suatu permasalahan dalam keseharian. Acara ini
                terdapat kegiatan seperti melakukan sosialisasi tentang
                teknologi, kerja bakti, dan kegiatan sosial lainnya. Kegiatan
          ...
          <div className="w-5/6 md:w-2/3 mx-auto flex flex-col">
            ...
            <div
              className="px-7 md:px-auto py-7 backdrop-blur-[6.300000190734863px] bg-[#FFFFFF1A] rounded-b-[48px] bg-cover bg-no-repeat"
              style={{ backgroundImage: "url(/oprec-volunteer/list-bg-2.png)" }}
            >
              <p className="text-sm md:text-lg text-justify">
                TechnoFair adalah program kerja unggulan Departemen akademik BEM
                FIKTI dan merupakan event IT terbesar di FIKTI yang dilaksanakan
                setiap tahun untuk mewadahi mahasiswa FIKTI UG dalam menyalurkan
                minat dan bakat di bidang akademik. Event ini berisi rangkaian
                acara berupa seminar, workshop, dan kompetisi.
              </p>
            </div>
          </div>
          <div className="w-5/6 md:w-2/3 mx-auto flex flex-col">
            <div className="bg-[#270548] w-full h-26 px-8 py-7 rounded-t-[48px]">
              ...
              <p className="text-xs md:text-sm pt-1">
                FIKTI Sport & Art Championship
              </p>
            </div>
            <div
              className="px-7 md:px-auto py-7 backdrop-blur-[6.300000190734863px] bg-[#FFFFFF1A] rounded-b-[48px] bg-cover bg-no-repeat"
              style={{ backgroundImage: "url(/oprec-volunteer/list-bg-3.png)" }}
            >
              <p className="text-sm md:text-lg text-justify">
                FIKTI SPACE (FIKTI Sport & Art Championship) adalah suatu
                rangkaian acara gabungan dari dua proker BEM FIKTI UG sebelumnya
                yaitu FAF dan FOSC berupa kompetisi olahraga dan seni budaya
                yang dilaksanakan oleh BEM FIKTI UG guna meningkatkan rasa
                sportivitas dan kreatifitas.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-20">
        <Image
          src={"/oprec-mobile/line-3-mobile.png"}
          alt="line"
          width={471}
          height={804}
          className="md:hidden block object-cover absolute w-full mx-auto "
        />
        {/* General Requirements Start */}
        <div className="md:block hidden relative">
          <Image
            src={"/oprec-mobile/dots-3.png"}
            alt="dots"
            width={170}
            height={90}
            className="w-24 ml-[1325px] mt-12 absolute"
          />
        </div>
        <div className="hidden md:block">
          <Image
            src={"/oprec-mobile/line-9.png"}
            alt="line"
            width={1509}
            height={1011}
            className="w-full absolute -mt-7"
          />
        </div>
        <div id="general" className="relative pb-28 pt-28 md:pt-24 md:pb-48">
            ...
            <div className="bg-[#662549] md:w-1/2 w-5/6 md:h-[623px] md:rounded-l-[150px] rounded-l-[44px] z-10">
              <div className="md:ml-9 py-7 px-8 md:py-20">
                <div className="md:text-center">
                  ...
                  <p className="text-center font-light md:text-lg text-xs">
                    Penuhi syarat dibawah ini untuk meningkatkan peluang
                    diterima sebagai relawan di program kerja
                  </p>
                </div>
                <div className="py-7 gap-4 grid md:my-2">
                  <div className="gap-3 flex">
                    <Image
                      src={"/oprec-mobile/toggle-mobile.png"}
                      alt="toggle"
                      width={38}
                      height={18}
                      className="md:w-12 md:h-8 w-8 h-4"
                    />
                    <p className="text-xs text-justify md:text-lg">
                      Mahasiswa aktif FIKTI Universitas Gunadarma
                    </p>
                  </div>
                  <div className="gap-3 flex">
                    <Image
                      ...
                      width={38}
                      height={18}
                      className="md:w-12 md:h-8 w-10 h-4"
                    />
                    <p className="text-xs text-justify md:text-lg">
                      Memiliki minat dan kompetensi yang relevan dengan program
                      volunteer yang akan dilaksanakan
                    </p>
                  </div>
                  <div className="gap-3 flex">
                    <Image
                    ...
                    />
                    <p className="text-xs text-justify md:text-lg">
                      Bersedia dan berkomitmen untuk menjadi bagian dari
                      kepanitiaan acara dan melaksanakan tugas-tugas dengan
                  ...
                  <div className="gap-3 flex">
                    ...
                    />
                    <p className="text-xs text-justify md:text-lg">
                      Memiliki kemampuan kerja sama tim, manajemen waktu, dan
                      pemprioritasan yang baik.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="md:block hidden">
            <Image
              ...
              width={170}
              height={90}
              className="w-24 ml-2 mt-10 absolute"
            />
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 my-32">
          <AccordionCard
            title="Divisi Acara"
            content="Mengatur seluruh rangkaian acara. Seperti membuat rundown acara beserta kebutuhannya, mencari pemateri, dll"
          />
          <AccordionCard
            title="Divisi Humas"
            content="Mengatur seluruh rangkaian acara. Seperti membuat rundown acara beserta kebutuhannya, mencari pemateri, dll"
        ...
        <div id="positions" className="md:px-0 px-8">
          ...
          <div className="md:hidden block">
            <Image
              src={"/oprec-mobile/lingkaran-4.png"}
              alt="lingkaran"
              width={150}
              height={150}
              className="w-40 -ml-10 mt-7 absolute object-cover"
            />
          </div>
          <div className="pt-24 md:hidden block z-10 relative">
            ...
            <p className="text-sm z-10">
              Divisi-divisi ini membutuhkan bantuanmu, Mari ramaikan acara-acara
              proyek ini!
            </p>
          </div>
          <div className="flex relative md:pt-32">
            <div className="hidden md:block">
              <Image
                src={"/oprec-volunteer/persegi-panjang.png"}
                alt="persegi panjang"
                width={90}
                height={443}
                className="absolute flex justify-start z-10 pt-4"
              />
            </div>
            <div className="w-1/2 md:w-2/3 flex relative py-4">
              <div className="w-56 h-48 md:w-3/4 md:h-[443px] backdrop-blur-[4.199999809265137px] bg-[#FFFFFF1A] rounded-tr-3xl rounded-bl-3xl md:rounded-r-[64px] md:rounded-l-none px-3 py-3 md:py-4 gap-2 grid">
                <div className="md:px-40 md:py-10 hidden md:block md:w-full md:ml-9">
                  ...
                  <p className="text-center text-md z-10">
                    Divisi-divisi dibawah ini membutuhkan bantuanmu, Yuk
                    ramaikan acara-acara proyek kerja ini!
                  </p>
                </div>
                  ...
                  <div className="grid gap-2 md:-mt-2">
                    <button type="button" onClick={btnAnimate}>
                      <div className="flex gap-4">
                        <Image
                          src={"/oprec-mobile/pin.png"}
                          alt="pin"
                          width={15}
                          height={18}
                          className="md:w-6 md:h-7"
                        />
                        <p className="text-xs md:text-xl underline md:pb-1 hover:text-[#F39F5A] after:text-[#B67744]">
                          Divisi Acara
                        </p>
                      </div>
                    </button>
            ...
            <div className="md:hidden block">
              <Image
                src={"/oprec-mobile/dots-6.png"}
                alt="dots"
                width={85}
                height={35}
                className="w-28 mt-32 -ml-10 absolute"
              />
            </div>
            <div
              className={`pl-10 pt-10 md:-ml-48 md:-mt-16 relative animate__animated ${
                showModal ? "animate__fadeOutRight" : "animate__fadeInRight"
              }`}
            >
              <Image
                src={"/oprec-volunteer/bejo-5.png"}
                alt="bejo"
                width={500}
                height={500}
              ...
              />
              <Image
                src={"/oprec-mobile/bejo-3.png"}
                alt="bejo"
                width={130}
                height={180}
                className={`w-full md:hidden block z-10 `}
              />
            </div>
            ...
            {showModal && (
              <div className={`relative p-4 w-full max-w-2xl max-h-full z-10`}>
                <div
                  className={`-ml-10 relative animate__animated ${
                    !showModal
                ...
                >
                  <div className="w-40 md:w-1/2 mx-auto flex flex-col">
                    <div className="bg-[#270548] w-full h-26 px-6 py-7 rounded-t-[48px]">
                      <h2 className="text-xl md:text-3xl font-bold whitespace-nowrap text-center">
                        Divisi Acara
                      </h2>
                    </div>
                    <div className="px-7 md:px-auto py-5 backdrop-blur-[6.300000190734863px] bg-[#FFFFFF1A] rounded-b-[48px] bg-cover bg-no-repeat">
                      <p className="text-[9px] md:text-2xl text-center">
                        Mengatur seluruh rangkaian acara. Seperti membuat
                        rundown acara beserta kebutuhannya, mencari pemateri,
                        dll
                      </p>
                    </div>
                  </div>
        ...
        <div className="join relative w-full pt-20 top-20 md:pt-28">
          <div className="pb-10">
            <div className="flex justify-center items-center">
              <Image
                src={"/oprec-volunteer/text-line.png"}
                alt="text line"
                width={128}
                height={22}
                className="absolute object-cover w-52 md:w-56 mx-auto mt-24 md:mt-28 md:mr-80"
              />
            </div>
            <div className="md:flex md:justify-center md:items-center md:gap-20">
              <div className="grid gap-6">
                <h1 className="text-center text-5xl font-bold z-10 font-Lato md:text-start md:text-6xl">
                  Join us.
                </h1>
                <p className="text-center text-sm md:text-justify md:text-md">
                  Kami mengajak kamu untuk bergabung <br /> dengan kami dan
                  membuat perbedaan. <br /> Daftarkan diri kamu sekarang juga!
                </p>
              </div>
            ...
            <div className="">
              <Image
                src={"/oprec-volunteer/line-10.png"}
                alt="line"
                width={22}
                height={33}
                className="md:hidden block w-10 ml-14 -mt-5"
              />
              <div className="flex justify-end items-end">
                <svg
                  className="mr-96 -mt-12"
                  xmlns="http://www.w3.org/2000/svg"
                  width="40"
                  height="78"
                  viewBox="0 0 68 105"
              ...
              <div className="md:flex md:justify-end">
                <div className="w-40 ml-5 -mt-3 md:mr-44 md:w-48 md:-mt-5">
                  <p className="text-justify text-md font-light opacity-50">
