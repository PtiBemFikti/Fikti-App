    ...
    <div className="main w-full font-Lato text-[#FFF6E0]">
      <div className="flex relative">
        <Image
          ...
          width={1029}
          height={975}
          className="object-cover absolute mx-auto w-full top-32"
        />
        <div
          className="bg-[#662549] w-1/2 rounded-e-[150px] mt-28 bg-no-repeat bg-left-bottom z-10"
          style={{ backgroundImage: "url(/oprec-volunteer/dots-5.png)" }}
        >
          <div className="ml-[64px] my-[30px]">
            <h2 className="pt-11 text-4xl font-bold">
              Open Recruitment Volunteer
            </h2>
            <h1 className="text-7xl font-bold">Harmoni Serasi</h1>
            <br />
            <p className="text-lg">
              Program kerja yang mewadahi mahasiswa aktif FIKTI UG untuk <br />{" "}
              berkontribusi dalam kepanitiaan acara dan kegiatan yang
              diselenggarakan <br /> oleh BEM FIKTI UG.
            </p>
            <br />
      ...
      <br />
      <div className="w-[320px] h-[120px] flex main items-start flex-column rounded-e-[24px] shadow-md">
