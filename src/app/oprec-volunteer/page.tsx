  ...
  return (
    <div className="main w-full font-Lato text-[#FFF6E0]">
      ...
      <div className="flex relative">
        <Image src={'/oprec-volunteer/line-9.png'} alt="line-bg" width={1029} height={975} className="object-cover absolute mx-auto w-full -top-7" />
        <div className="bg-[#662549] w-2/3 h-5/6 rounded-e-[200px] mt-36 bg-no-repeat bg-left-bottom z-10" style={{ backgroundImage: 'url(/oprec-volunteer/dots-5.png)' }}>
          <div className=" ml-20 my-12 py-12">
            <h2 className="text-4xl font-bold">Open Recruitment Volunteer</h2>
      ...
      <div className="w-full flex flex-col justify-center items-center mt-32">
        ...
        <div className="grid grid-rows-1 gap-7 pb-10">
          <div className="w-2/3 mx-auto flex flex-col">
            ...
            <div className="px-14 py-7 backdrop-blur-[6.300000190734863px] bg-[#FFFFFF1A] rounded-b-[48px]">
              <p className="text-lg">
          ...
          <div className="w-2/3 mx-auto flex flex-col">
            <div className="bg-[#270548] w-full h-26 px-8 py-7 rounded-t-[48px]">
              <h2 className="text-5xl font-bold whitespace-nowrap">TechnoFair 11.0</h2>
            </div>
            <div className="px-14 py-7 backdrop-blur-[6.300000190734863px] bg-[#FFFFFF1A] rounded-b-[48px]">
              <p className="text-lg">
          ...
          <div className="w-2/3 mx-auto flex flex-col">
            <div className="bg-[#270548] w-full h-26 px-8 py-7 rounded-t-[48px]">
              <h2 className="text-5xl font-bold whitespace-nowrap">FIKTI SPACE</h2>
              <p className="text-sm pt-1">FIKTI Sport & Art Championship</p>
            </div>
            <div className="px-14 py-7 backdrop-blur-[6.300000190734863px] bg-[#FFFFFF1A] rounded-b-[48px]">
              <p className="text-lg">
