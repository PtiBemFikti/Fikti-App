...
import { dataBiroDepartemen } from "@/app/struktur-organisasi/data/BirDep";
import { useParams } from "next/navigation";
import aboutImg from "../../../../public/about.jpeg";
import HeroSection from "@/components/landing-page/dashboard";
import AboutPage from "@/components/struktur-organisasi/section/HeroSection";
...
export default function BiroDepartemenPage() {
  ...
  const biroDepartemen = dataBiroDepartemen.find(
    (data) => data.slug === `/struktur-organisasi/${birDep}`
  );
  ...
  return (
    <>
      {/* KONTEN YANG ATAS */}
      <div className="relative z-10 w-screen h-fit text-white bg-black">
        <div className="flex flex-col items-center justify-center">
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center relative z-10 mx-6 mt-16 md:mt-0">
              ...
              <h2 className="text-base text-white md:text-xl text-center mb-8 md:mb-12 max-w-3xl drop-shadow-lg">
      ...
      {/* KONTEN YANG BAWAH */}
      <div className="py-4 w-full h-fit flex flex-col items-center justify-center section-about pb-36 px-5">
        {/* Kepemimpinan */}
        <h2 className="text-center text-3xl md:text-[3rem] font-semibold mb-12">
          Kepemimpinan
        ...
        {/* Staff */}
        <h2 className="text-center text-3xl md:text-[3rem] font-semibold my-12">
          Our Staff
          <span className="block w-[80%] h-1 bg-purple-500 mx-auto mt-5"></span>
        </h2>
        <div className="relative overflow-hidden w-full md:w-[100%] lg:w-[70%]">
